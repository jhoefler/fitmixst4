...
mixstEst <- function (y, g, itermax, error, pro, mu, Sigma, delta, nu, verbose=F) 
.Call("file44b370f6487", y, g, itermax, error, pro, mu, Sigma, 
    delta, nu, verbose, PACKAGE = "fitmixst")
