...
mixstEst <- function (y, g, itermax, error, pro, mu, Sigma, delta, nu, verbose=F, beta) 
	.Call("fitmixstC", y, g, itermax, error, pro, mu, Sigma, 
			delta, nu, verbose, beta, PACKAGE = "fitmixst4")
